# PHY 607 - Class 8 - Thursday, September 17, 2026

**Remote class.** We meet in room 208 as usual; I will join by video.
This is the last remote class — I am back in person Tuesday, September 22.
...
* Determine what the modified hamiltonian is for the 1d spring oscillator when
  using the Euler symplectic integrator method.
    * *Hint: compare the unmodified energy at each time step. What would you have
      to add to get a conserved form?*
